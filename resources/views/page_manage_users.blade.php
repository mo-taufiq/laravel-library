...
<div class="p-3 content-container">
    ...
    <div class="d-flex justify-content-start flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
        ...
        <div class="btn-toolbar mb-2 mb-md-0 ms-3">
            <a href="{{ url('page/admin/users/add') }}">
                ...
                <tr>
                    <th>
                        <div class="w-100 d-flex justify-content-center align-items-center">
                            <a href="{{ url('page/admin/users/' . $user->user_id) }}">
                    ...
                    <td>
                        <span style="font-size: 11px;"
                            class="badge rounded-pill bg-{{ ($user->role === 'Admin') ? 'dark' : 'secondary' }}">{{
                            $user->role }}</span>
                    </td>
                    <td>
                        <div class="w-100 d-flex justify-content-center align-items-center"
                            style="width: 100px;height: 25px;">
                            <img src="{{ asset($user->image) }}" alt="" class="w-100 h-100"
